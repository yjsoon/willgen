const Layout = ({ children }) => {
  return (
    <div className="antialiased flex flex-col items-center justify-center min-h-screen py-2">
      <main className=" text-gray-900 py-10 align-center flex flex-col flex-1 items-center">
